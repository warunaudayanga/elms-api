export enum FKConstraint {
    ...
    CLASS_PAYMENT_CLASS_STUDENT = "FK_classPayment_classStudent",
    CLASS_PAYMENT_CLASS_ROOM = "FK_classPayment_classRoom",
    CLASS_PAYMENT_PAYMENT = "FK_classPayment_payment",
